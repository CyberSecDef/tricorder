...
export class PlannedInstrument extends Instrument {
  ...
  protected build(root: HTMLElement): void {
    ...
    append(
      ...
      section('Principle'),
      el('div', { class: 'notice', style: 'border-left-color:var(--dark1);background:color-mix(in srgb, var(--dark1) 12%, var(--bg))' }, p.principle),
      section('Must be resolved first'),
      el('ul', { class: 'notice', style: 'border-left-color:var(--dark2);background:color-mix(in srgb, var(--dark2) 12%, var(--bg))' },
